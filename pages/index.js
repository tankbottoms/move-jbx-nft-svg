...
// Constants: token name and address mapping, Uniswap 
const TOKENS = [
...
const PLACEHOLDER = [
  { name: "Project URL", address: "0x6b175474e89094c44da98b954eedeac495271d0f" },
]

const PROJECTS = [
  { name: "PandaDAO", address: "0x6b175474e89094c44da98b954eedeac495271d0f" },
  { name: "JuiceboxDAO", address: "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48" },
  { name: "PresidentialDAO", address: "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2" },
  { name: "Peel", address: "0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9" },
  { name: "CanuDAO", address: "0x3472a5a71965499acd81997a54bba8d852c6e53d" },
  { name: "SharkFrens", address: "0xc00e94cb662c3520282e6f5717214004a7f26888" },
  { name: "PeaceDAO", address: "0xd533a949740bb3306d119cc777fa900ba034cd52" },
  { name: "MosaicDAO", address: "0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2" },
  { name: "WagmiStudios", address: "0x0cec1a9154ff802e7934fc916ed7ca50bde6844e" },
  { name: "JohnnyDAO", address: "0x408e41876cccdc0f92210600ef50372656052a38" },  
];
...
const JBX_PROJECT = {
  ...
  handle: "juicebox",
  projectId: 1,
  description: "Juicebox Project description placeholder. (section 0)",
  website: "https://snapshot.org/#/jbdao.eth",
...
export default function Home() {
  ...
  const [tokenId, setTokenId] = useState(Math.floor(Math.random() * 1000));
  ...
  const [baseTokenSymbol, setBaseTokenSymbol] = useState("PROJECT URL");
  const [quoteTokenSymbol, setQuoteTokenSymbol] = useState("PROJECT NAME");
  ...
  const randomizeNFT = () => {
    ...
    // Tokens
    const token0 = selectRandomItemFromArray(PLACEHOLDER);
    const token0OmittedTokens = TOKENS.filter(
      (token) => token.address != token0.address
    );
    const token1 = selectRandomItemFromArray(PROJECTS);
